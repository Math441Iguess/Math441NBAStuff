...
[~, ~, raw] = xlsread('/Users/Eason/Desktop/RESET-COMP.xlsx','Use this as Ind. Data');
...
%% Exclude rows with non-numeric cells       do not do this 
...
[~, ~, raw] = xlsread('/Users/Eason/Desktop/RESET-COMP.xlsx','Use this as Championshp Data');
...
% M = min(b[i],A[i]) % for i in range b and for i in range A.... how do i write a loop
