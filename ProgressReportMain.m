...
%% Import the data
[~, ~, raw] = xlsread('/Users/owner/Documents/MATLAB/Math441NBAStuff/RESET COMP.xlsx','Use this as Ind. Data');
raw = raw(:,[3,6:end]);
...
%% Import the data
[~, ~, raw] = xlsread('/Users/owner/Documents/MATLAB/Math441NBAStuff/RESET COMP.xlsx','Sheet1');
raw = raw(195,3:end);
raw = sortrows(raw,3);
%% Create output variable
data = reshape([raw{:}],size(raw));
